...
<div id="singleColumn">
    ...
    <h2 style="font-family:Avenir;"><fmt:message key="checkout"/></h2>

    <p style="font-family:Avenir;"><fmt:message key="checkoutText"/></p>

    <c:if test="${!empty orderFailureFlag}">
        <p class="error" style="font-family:Avenir;"><fmt:message key="orderFailureError"/></p>
    </c:if>

    <form id="checkoutForm" action="<c:url value='purchase'/>" method="post">
        <table id="checkoutTable" style="font-family:Avenir;">
    ...
    <div id="infoBox" style="font-family:Avenir;">
        ...
        <table id="priceBox" style="font-family:Avenir;">
            <tr>
