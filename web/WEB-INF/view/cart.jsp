...
<div id="singleColumn">
    ...
    <div id="actionBar" style="font-family:Avenir;">
        <%-- clear cart widget --%>
    ...
    <c:if test="${!empty cart && cart.numberOfItems != 0}">
      ...
      <h4 id="subtotal" style="font-family:Avenir;"><fmt:message key="subtotal"/>:
          <fmt:formatNumber type="currency" currencySymbol="&euro; " value="${cart.subtotal}"/>
      </h4>

      <table id="cartTable" style="font-family:Avenir;">
          ...
          <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">
            <td>
                <img src="${initParam.productImagePath}${product.name}.jpg"
                     alt="<fmt:message key="${product.name}"/>" style="width:200px;height:200px;">
            </td>

            <td class="cartText"><fmt:message key="${product.name}"/></td>
