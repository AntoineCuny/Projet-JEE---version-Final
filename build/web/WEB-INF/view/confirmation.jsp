...
<div id="singleColumn">
    ...
    <p id="confirmationText">
        ...
        <strong style="color:white;">${orderRecord.confirmationNumber}</strong>
        <br>
    ...
    <div class="summaryColumn" >
        ...
        <table id="orderSummaryTable" class="detailsTable" style="color:white;">
            <tr class="header">
                <th colspan="3"><fmt:message key="orderSummary"/></th>
            </tr>

            <tr class="tableHeading" style="color:#444">
    ...
    <div class="summaryColumn" >
        ...
        <table id="deliveryAddressTable" class="detailsTable" style="color:white;">
            <tr class="header">
